...
class CockFightScreen extends React.Component{
...
const load_data  = (state) =>{
  return { 
    ...
    slider_images : state.slider.cockfight_images,
...
export default connect(load_data, {providerchange,gametypechange,filterData,data_load})(CockFightScreen);
