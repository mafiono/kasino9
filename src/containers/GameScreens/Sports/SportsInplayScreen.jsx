...
class SportsInplayScreen extends React.Component{
  ...
  componentDidMount() {
    this.props.get_sports_lists(sportsconfig.matchType['Inplay']);
...
export default connect(mapStateToProps, mapDispatchToProps)(SportsInplayScreen)
